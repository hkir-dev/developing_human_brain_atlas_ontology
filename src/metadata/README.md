 ...
 * [dhbao.yml](dhbao.yml)
     * Determines how your purl.obolibrary.org/obo/dhbao/ redirects will be handled
     ...
     * Paste in the contents of [dhbao.yml](dhbao.yml)
 ...
 * [dhbao.md](dhbao.md)
     ...
     * Paste in the contents of [dhbao.md](dhbao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
