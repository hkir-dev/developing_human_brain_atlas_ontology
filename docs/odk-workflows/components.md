...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/dhbao-odk.yaml)
...
```
  <uri name="https://purl.brain-bican.org/ontology/dhbao/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/dhbao-edit.obo)
for .obo formats: 

```
import: https://purl.brain-bican.org/ontology/dhbao/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/dhbao.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
